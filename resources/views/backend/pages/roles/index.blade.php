                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-success btn-sm" href="{{route('roles.edit',$role->id)}}">Edit</a> <a class="btn btn-danger btn-sm" href="{{ route('roles.destroy',$role->id)}}"
                          onclick="event.preventDefault();
                          document.getElementById('delete-form-{{$role->id }}').submit();">{{ __('Delete') }}</a>
